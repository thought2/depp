...
(function(exports) {
  ...
  var genericLanguage = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Types line 124, column 8 - line 124, column 54: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var eqLanguage = new Data_Eq.Eq(Data_Generic_Rep_Eq.genericEq(genericLanguage)(Data_Generic_Rep_Eq.genericEqSum(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))(Data_Generic_Rep_Eq.genericEqConstructor(Data_Generic_Rep_Eq.genericEqNoArguments))));
  var ordLanguage = new Data_Ord.Ord(function () {
      return eqLanguage;
  }, Data_Generic_Rep_Ord.genericCompare(genericLanguage)(Data_Generic_Rep_Ord.genericOrdSum(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments))(Data_Generic_Rep_Ord.genericOrdConstructor(Data_Generic_Rep_Ord.genericOrdNoArguments))));
  ...
  var enumLanguage = new Data_Enum.Enum(function () {
      return ordLanguage;
  }, Data_Generic_Rep_Enum.genericPred(genericLanguage)(Data_Generic_Rep_Enum.genericEnumSum(Data_Generic_Rep_Enum.genericEnumConstructor(Data_Generic_Rep_Enum.genericEnumNoArguments))(Data_Generic_Rep_Bounded.genericTopConstructor(Data_Generic_Rep_Bounded.genericTopNoArguments))(Data_Generic_Rep_Enum.genericEnumConstructor(Data_Generic_Rep_Enum.genericEnumNoArguments))(Data_Generic_Rep_Bounded.genericBottomConstructor(Data_Generic_Rep_Bounded.genericBottomNoArguments))), Data_Generic_Rep_Enum.genericSucc(genericLanguage)(Data_Generic_Rep_Enum.genericEnumSum(Data_Generic_Rep_Enum.genericEnumConstructor(Data_Generic_Rep_Enum.genericEnumNoArguments))(Data_Generic_Rep_Bounded.genericTopConstructor(Data_Generic_Rep_Bounded.genericTopNoArguments))(Data_Generic_Rep_Enum.genericEnumConstructor(Data_Generic_Rep_Enum.genericEnumNoArguments))(Data_Generic_Rep_Bounded.genericBottomConstructor(Data_Generic_Rep_Bounded.genericBottomNoArguments))));
  var boundedLanguage = new Data_Bounded.Bounded(function () {
      return ordLanguage;
  }, Data_Generic_Rep_Bounded.genericBottom(genericLanguage)(Data_Generic_Rep_Bounded.genericBottomSum(Data_Generic_Rep_Bounded.genericBottomConstructor(Data_Generic_Rep_Bounded.genericBottomNoArguments))), Data_Generic_Rep_Bounded.genericTop(genericLanguage)(Data_Generic_Rep_Bounded.genericTopSum(Data_Generic_Rep_Bounded.genericTopConstructor(Data_Generic_Rep_Bounded.genericTopNoArguments))));
...
(function(exports) {
      ...
      return function (sep) {
          return Data_Functor.mapFlipped(Text_Parsing_StringParser.functorParser)(Text_Parsing_StringParser_Combinators.sepBy1(p)(sep))(function (v) {
              ...
              return __unused()((function () {
                  ...
                  throw new Error("Failed pattern match at Specs line 96, column 50 - line 96, column 91: " + [ v.constructor.name ]);
              })());
          });
      };
  };
  ...
  var langSpecs = function (lang) {
      ...
      throw new Error("Failed pattern match at Specs line 31, column 3 - line 41, column 8: " + [ lang.constructor.name ]);
  };
...
(function(exports) {
  ...
  var handleOutput = function (output1) {
      ...
      throw new Error("Failed pattern match at Main line 226, column 3 - line 234, column 1: " + [ output1.constructor.name ]);
  };
  var getDot = function (v) {
      var f = function (v1) {
          return Copy.withTicks(modulePathToStr(v1.value1)) + (" -> " + (Copy.withTicks(modulePathToStr(v1.value0)) + ";"));
      };
      return Types.SourceStrDot("digraph {\x0a" + (Data_String.joinWith("\x0a")(Data_Functor.map(Data_Functor.functorArray)(f)(v)) + "}"));
  };
  ...
  var run = function (task) {
      ...
      throw new Error("Failed pattern match at Main line 128, column 3 - line 131, column 37: " + [ task.constructor.name ]);
  };
  ...
  var outputError = function (err) {
      ...
      throw new Error("Failed pattern match at Main line 199, column 3 - line 215, column 26: " + [ err.constructor.name ]);
  };
  var output = function (result) {
      ...
      throw new Error("Failed pattern match at Main line 189, column 3 - line 195, column 29: " + [ result.constructor.name ]);
  };
