      ...
      return function (sep) {
          return Data_Functor.mapFlipped(Text_Parsing_StringParser.functorParser)(Text_Parsing_StringParser_Combinators.sepBy1(p)(sep))(function (v) {
              ...
              return __unused()((function () {
                  ...
                  throw new Error("Failed pattern match at Specs line 87, column 23 - line 87, column 64: " + [ v.constructor.name ]);
              })());
          });
      };
  };
...
(function(exports) {
  ...
  var getDot = function (v) {
      ...
      return Types.SourceStrDot("digraph {\x0a" + ("rankdir=LR;\x0a" + (Data_String.joinWith("\x0a")(Data_Functor.map(Data_Functor.functorArray)(f)(v)) + "\x0a}")));
  };
